...
export default function ReconToolsPage() {
  const reconTools = toolkitData.filter(tool => tool.category === 'Reconnaissance');
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-6">
                ...
                <Link href="/recon" className="text-foreground hover:text-primary transition-colors">
                  Reconnaissance
                </Link>
                ...
                <Link href="/wifi-network-hacking" className="text-muted-foreground hover:text-primary transition-colors">
                  WiFi & Network Hacking
                </Link>
                <Link href="/recon-tools" className="text-foreground hover:text-primary transition-colors">
                  Recon Tools
                </Link>
              </div>
            </div>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Additional reconnaissance tools for information gathering and attack surface mapping.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          {filteredTools.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              No reconnaissance tools found matching your criteria.
            </div>
          ) : (
